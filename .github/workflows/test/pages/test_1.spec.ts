...
import { BilllistPage } from './Billlist-page';

import { BillcreatePage } from './Billcreate-page';

import { BilleditlPage } from './Billedit-page';

import { ClientCreatePage } from './Clientcreate-page';

import { ClientEditPage } from './Clientedit-page';

import { ClientListPage } from './Clientlist-Page';

import { DashboardPage } from './Dashboard-page';

import { FakerPage } from './Faker-page';

import { faker } from "@faker-js/faker";

import { LoginPage } from './Login-page';

import { ReservationvlistPage } from './Reservationlist-page';
